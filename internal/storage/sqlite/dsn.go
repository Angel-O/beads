...
func dsn(path string) string {
	...
	return "file:" + path + "?_pragma=foreign_keys(1)&_pragma=busy_timeout(5000)&_pragma=journal_mode(WAL)&_pragma=case_sensitive_like(1)&_txlock=immediate&_time_format=datetime"
}
